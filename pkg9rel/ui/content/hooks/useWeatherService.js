...
export const createUseWeatherService = ({ 
  ...
  apiKey, cacheTtlMs, rateLimitMs, formatTimezone 
}) => {
  ...
  return () => {
    ...
    const fetchWeather = useCallback(async (lat, lon) => {
      ...
      if (cached) {
        setData(cached); setTzLabel(formatTimezone(cached.timezone)); setErr(null);
        return cached;
      }
      ...
      try {
        ...
        setData(payload);
        setTzLabel(formatTimezone(payload.timezone));
        return payload;
